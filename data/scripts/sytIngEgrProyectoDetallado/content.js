var postURL = "http://localhost/sayet/php/rptingegrproy.php/detalle";
...
function beforeRender(req, res, done) {
    ...
    require("request")({
        method:"POST",
        body: params,
        //body: { "idempresa":"6", "idproyecto":"4", "mes":"10", "anio":"2017" },
        json: true,
        url: postURL 
        ...
        //req.template.content = JSON.stringify(req.data.movs.ingresos);
        done();
    });
}