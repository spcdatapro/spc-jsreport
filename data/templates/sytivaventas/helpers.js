...
function getTotales(data){
    var suma = {
        tbien: 0.00, tserv: 0.00, tiva: 0.00, tventa: 0.00, texento: 0.00
    };
    ...
    data.forEach(function(lbc){
        ...
        suma.tventa += parseFloat(parseFloat(lbc.totfact).toFixed(2));
    ...
    tabla += "<td class='total2'>" + numberWithCommas(suma.tventa.toFixed(2), 0) + "</td>";
    tabla += "</tr>";
    return tabla;
}
